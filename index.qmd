...
To explore this, the project applies computational audio features—chroma (harmony), MFCC (timbre), novelty curves (structure), and tempograms (rhythm)—to identify measurable differences between these periods. In addition, three representative tracks are analysed in detail: “Wicked Games” and “Blinding Lights”. These are the most streamed tracks of either trilogy. Because of personal biases "After Hours" will also be analysed alongside these 2 other songs, In my opinion this is the most interesting piece of music he brought out on both trilogies  

Research question:
To what extent do computational audio features (chroma, MFCC, novelty curves, and tempograms) provide consistent evidence for a stylistic evolution in The Weeknd’s music between his early Trilogy and his later, conceptually defined trilogy?
:::
...
This project set out to examine how The Weeknd’s music has evolved over time by comparing his early Trilogy material with his later albums, using both corpus-level features and detailed analyses of representative tracks such as Wicked Games and Blinding Lights.      

The results indicate a clear shift from a relatively uniform and loop-based musical style toward a more varied and structurally complex sound. Early work, as exemplified by Wicked Games, is characterized by high harmonic stability, repetitive structures, and limited variation in timbre and temporal organization. This is reflected in consistent chroma patterns, stable cepstral representations, and clustered novelty peaks that suggest incremental rather than large-scale change.      

In contrast, later work such as Blinding Lights and After Hours demonstrates increased segmentation, clearer structural boundaries, and greater rhythmic regularity. Novelty curves reveal more evenly distributed and interpretable structural changes, while tempograms show stronger and more continuous periodicities, indicating a more defined rhythmic framework. At the same time, cepstral features point to a denser and more layered timbral profile, reflecting more complex production techniques.      

At the corpus level, this evolution is further supported by broader distributions in features such as energy, tempo, and acousticness in the later trilogy, suggesting increased stylistic diversity. Clustering results reinforce this trend, showing that newer tracks are less tightly grouped and exhibit more variation in their feature profiles compared to earlier work.     

Overall, the data suggests that The Weeknd’s musical evolution can be understood as a transition from introspective, sonically cohesive compositions toward more rhythmically driven, structurally explicit, and timbrally rich productions. While computational features cannot fully capture musical meaning, they provide consistent evidence of this shift, highlighting an expansion in both expressive range and production complexity over time.
:::