...
The cluster heatmap groups tracks based on similarities in features such as energy, loudness, tempo, and valence. This allows us to compare tracks based on measurable characteristics rather than genre labels, although these features remain simplified representations of music.

**Blinding Lights** clusters with tracks that have high energy and loudness, reflecting a strong, rhythm-driven production style. In contrast, **After Hours** and **Wicked Games** are positioned closer together, indicating more similar feature profiles with lower energy and a more atmospheric character.

The heatmap also shows outliers, such as “Until We’re Skin & Bones,” which stands out due to high instrumentalness, suggesting a different type of arrangement.

Additionally, some features are clearly related: energy and loudness cluster together, while valence appears more independent.

Overall, the clustering highlights general similarities in production and style, but should be interpreted carefully since these numerical features cannot fully capture musical expression.
